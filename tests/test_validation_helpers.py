...
class TestPROperations:
    ...
    def test_needs_pr_update_operation_true_cases(self):
        ...
        configs = [
            {"update_if_exists": True, "comment": False, "update_pr_body": False, "add_labels": False, "link_issue": False},
            {"update_if_exists": False, "comment": True, "update_pr_body": False, "add_labels": False, "link_issue": False},
            {"update_if_exists": False, "comment": False, "update_pr_body": True, "add_labels": False, "link_issue": False},
            {"update_if_exists": False, "comment": False, "update_pr_body": False, "add_labels": True, "link_issue": False},
            {"update_if_exists": False, "comment": False, "update_pr_body": False, "add_labels": False, "link_issue": True},
        ]
